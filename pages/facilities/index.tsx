...
const FacilityPage = () => {
  ...
  const [formState, setFormState] = React.useState<FacilityMutationType>({
    estateName: "",
    estateDescription: "",
    totalLandSize: undefined,
    totalLandPrice: undefined,
    estateLocation: {
      address: "",
      city: "",
      state: "",
  ...
  const [formStateEdit, setFormStateEdit] =
    React.useState<FacilityMutationType>({
      estateName: "",
      estateDescription: "",
    });
                      ...
                      InputProps={{
                        ...
                        endAdornment: (
                          <InputAdornment position="end">
                            <Typography variant="caption">Sqm</Typography>
                          </InputAdornment>
                        ),
                      }}
                    />
                    ...
                    {[...Array(buildings)].map((e, i) => (
                      ...
                      >
                        <Stack direction="row" justifyContent="space-between">
                          ...
                          <Button
                            onClick={() => setBuildings((state) => state + 1)}
                            sx={{ borderRadius: "20px", mb: "15px" }}
                            variant="outlined"
                            color="info"
                          >
                            <AddCircleOutline />
                  ...
                  <Stack spacing={3}>
                    <Stack spacing={2}>
                      ...
                      <TentTextField
                        ...
                        label="Estate Information"
                        value={
                          openEdit && formStateEdit && formStateEdit.estateName
                        }
                        fullWidth
                      />
                      <TentTextField
                        ...
                        value={
                          openEdit &&
                          formStateEdit &&
                          formStateEdit.estateDescription
                        }
                        minRows={5}
                        multiline
                      />
            ...
            <Stack spacing={1}>
              <Grid spacing={2} container>
                <Grid lg={3} md={3} sm={6} xs={12} item>
                  <DataCountCard>
                    <Typography variant="h6">
                      {!loadingError && facilityData.data.totalBuildings}
                    </Typography>
                ...
                <Grid lg={3} md={3} sm={6} xs={12} item>
                  <DataCountCard>
                    <Typography variant="h6">
                      {!loadingError && facilityData.data.totalEstates}
                    </Typography>
                ...
                <Grid lg={3} md={3} sm={6} xs={12} item>
                  <DataCountCard>
                    <Typography variant="h6">
                      {!loadingError && facilityData.data.totalLandSize}
                    </Typography>
                ...
                <Grid lg={3} md={3} sm={6} xs={12} item>
                  <DataCountCard>
                    <Typography variant="h6">
                      {!loadingError && facilityData.data.totalUnitSold}
                    </Typography>
                                          ...
                                          <IconButton
                                            onClick={() => {
                                              setFormStateEdit({
                                                ...
                                                estateLocation: {
                                                  address:
                                                    row.estateLocation.address,
                                                  city: row.estateLocation.city,
                                                  state:
                                                    row.estateLocation.state,
                                                  zipCode:
                                                    row.estateLocation.zipCode,
                                                },
                                              });
                                              setOpenEdit({
                                                toggle: true,
